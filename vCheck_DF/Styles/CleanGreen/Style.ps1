...
<html xmlns="http://www.w3.org/1999/xhtml">
   <head>
      <title>_HEADER_</title>
        ...
        <table width='100%'><tr><td style='font-size:11pt; font-weight:bold; height: 25px; text-align: center; vertical-align: middle; color: red;'>To have additional ESX hosts added to this scan, contact Rick Baillie.</td></tr></table>
		<style type='text/css'>
         table	{
            width: 100%;
            margin: 0px;
   ...
   <table width='100%'><tr><td style='font-size:9pt; height: 25px; text-align: center; vertical-align: middle; color: #000000;'>Edited by Dave Frankel & Rick Baillie</td></tr></table>
   </body>
</html>      
"@
